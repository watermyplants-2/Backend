...
// what password encoder is in

    @Autowired
    private PasswordEncoder encoder;
//configure client details service for our app created and managed by spring
...
//Connects endpoints to our authentication and token store
